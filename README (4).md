...
To run this program, you can use VScode and use the Terminal to perform the required steps. Make sure to save all the codes for it to run smoothly.
...
To open it in browser, you can search for "localhost:3000" and it will show the interface for this program.
